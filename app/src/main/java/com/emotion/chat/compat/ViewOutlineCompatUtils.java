...
package com.emotion.chat.compat;

import android.inputmethodservice.InputMethodService;
import android.os.Build;
import android.view.View;

public class ViewOutlineCompatUtils {
    ...
    private ViewOutlineCompatUtils() {
    ...
    public static InsetsUpdater setInsetsOutlineProvider(final View view) {
        ...
        return ViewOutlineCompatUtilsL.setInsetsOutlineProvider(view);
    }
}
